...
const ForgotPassword: React.FC = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (backendMessage === 'Usuário não encontrado com as credenciais fornecidas!') {
        setErrors({
    ...
    <IonPage>
      <IonContent style={{ "--background": "var(--ion-color-tertiary)" }}>
        <Container>
          ...
          <Text>
            Para sua segurança, enviaremos um código para validar a redefinição da senha.
          </Text>
          ...
          <ButtonContainer>
            ...
            <Button onClick={handleSubmit} variant="secondary" style={{ marginTop: '32px' }}>
              SOLICITAR CÓDIGO
            </Button>
          </ButtonContainer>
        </Container>
